...
fn invoke_handler() -> impl Fn(tauri::ipc::Invoke) -> bool + Send + Sync + 'static {
    ...
    tauri::generate_handler![
        ...
        list_custom_fields, create_custom_field, update_custom_field, set_custom_field_active, get_custom_values, set_custom_values,
        list_consent, record_consent, withdraw_consent, export_student, erase_student, get_retention, set_retention, list_incidents, add_incident, list_privacy_actions,
